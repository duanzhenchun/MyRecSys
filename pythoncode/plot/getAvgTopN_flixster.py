...
def main():
    ...
    filePath = filePath + 'cmimTopN.txt'
    f = open(filePath,'w')
    
    
    basename = '\\result\\flixster\\som\\cmim\\'
    topNname = 'final_flixster_cmim_prf_top10.txt'
    filename = basename + topNname
    precision,recall,f1 = loaddata(filename)
    writeline = '%1.4f\t%1.4f\t%1.4f\r\n' % (precision,recall,f1)
    f.write(writeline)
    
    topNname = 'final_flixster_cmim_prf_top20.txt'
    filename = basename + topNname
    precision,recall,f1 = loaddata(filename)
    writeline = '%1.4f\t%1.4f\t%1.4f\r\n' % (precision,recall,f1)
    f.write(writeline)
 
    topNname = 'final_flixster_cmim_prf_top30.txt'
    filename = basename + topNname
    precision,recall,f1 = loaddata(filename)
    writeline = '%1.4f\t%1.4f\t%1.4f\r\n' % (precision,recall,f1)
    f.write(writeline) 
    ...
    topNname = 'final_flixster_cmim_prf_top40.txt'
    filename = basename + topNname
    precision,recall,f1 = loaddata(filename)
    writeline = '%1.4f\t%1.4f\t%1.4f\r\n' % (precision,recall,f1)
    f.write(writeline)
    
    topNname = 'final_flixster_cmim_prf_top50.txt'
    filename = basename + topNname
    precision,recall,f1 = loaddata(filename)
    writeline = '%1.4f\t%1.4f\t%1.4f\r\n' % (precision,recall,f1)
    f.write(writeline)

...
def main():
	...
	rawCoreUserList = GetRawCoreUserID()
	GetSocialDataAndWriteToTxt(rawCoreUserList,socialList,'raw')
...
def GetSocialDataAndWriteToTxt(rawCoreUserList,socialList,mark):
	codePath=sys.path[0]
	s=codePath.split('\\')

...
resultFileName=sprintf('..\\..\\..\\result\\flixster\\socialmf_topN\\flixster_socialmf_result_%d_%s.txt',version,date);
...
modelFileName = sprintf('..\\..\\..\\data\\flixster\\socialmfdata_topN\\socialMF_iter300_fac_50rm-1_wm0.020_beta0.001_lamb0.001_ver%d.mat',version); %SVD模型文件名
...
[coverage,avgILS,interestCover]  = DiversityAnalysis(allUserFinalRecList, itemCount,itemSimiMatrix, itemClassIndex);
fprintf('coverage is %f, avgILS is %f,interestCover is %f \n ',coverage,avgILS,interestCover);

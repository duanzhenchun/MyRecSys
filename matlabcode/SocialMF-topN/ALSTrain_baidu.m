function [Q,P] = ALSTrain_baidu(R,S,n_factors,n_iterations,lambda,epsilon,beta,rm,wm, userSocialTrustCell ,costTol)
...
%         Ri = RTcell{i};
    ...
    cost = GetCost_baidu(R, Q, P, W, rm, lambda, beta, userSocialTrustCell);

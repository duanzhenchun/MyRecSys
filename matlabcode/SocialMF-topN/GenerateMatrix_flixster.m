...
socialFileName = sprintf('..\\..\\..\\data\\flixster\\commondata\\finalSocial%d.txt',version);

saveRatingFileName = sprintf('..\\..\\..\\data\\flixster\\commondata\\bigUserRatingMatrix%d.mat',version);
saveSocialFileName = sprintf('..\\..\\..\\data\\flixster\\commondata\\socialMatrix%d.mat',version);
saveUserFileName =  sprintf('..\\..\\..\\data\\flixster\\commondata\\bigUser%d.mat',version);

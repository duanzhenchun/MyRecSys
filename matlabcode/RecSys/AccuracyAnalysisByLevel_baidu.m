...
oldRecInfoFileName = sprintf('..\\..\\..\\data\\baidu\\somdata\\oldRecInfo%d.mat',version);
newRecInfoFileName = sprintf('..\\..\\..\\data\\baidu\\somdata\\newRecInfo%d.mat',version);
...
for levelIdx = 1: 6
levelFileName = sprintf('..\\..\\..\\result\\baidu\\som\\cmim\\final_baidu_cmim_level%d.txt',levelIdx);
...
for levelIdx = 1: 6
levelFileName = sprintf('..\\..\\..\\result\\baidu\\som\\pbmim\\final_baidu_pbmim_level%d.txt',levelIdx);

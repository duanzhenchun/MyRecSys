...
for version = 1:30
    ...
    allUserRecInfoFile = sprintf('..\\..\\..\\result\\flixster\\som\\%s\\allUserRecInfo%d.mat',algorithm,version);   
    ...
    % itemSimiFileName=sprintf('..\\..\\..\\data\\flixster\\ibcfdata\\itemSimiMatrix%d.mat',version);
    ...
    finalDiversityFileName=sprintf('..\\..\\..\\result\\flixster\\som\\%s\\final_flixster_%s_diversity_topK%d.txt',algorithm,algorithm,topK);
    finalColdUserResultFileName = sprintf('..\\..\\..\\result\\flixster\\som\\%s\\final_flixster_%s_colduser_topK%d.txt',algorithm,algorithm,topK);

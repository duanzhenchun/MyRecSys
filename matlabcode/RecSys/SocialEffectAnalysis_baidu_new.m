...
oldRecInfoFileName = sprintf('..\\..\\..\\data\\baidu\\somdata\\100oldRecInfo%d.mat',version);
newRecInfoFileName = sprintf('..\\..\\..\\data\\baidu\\somdata\\100newRecInfo%d.mat',version);
...
for i=1:levelNum
    ...
    SocialEffectFileName = sprintf('..\\..\\..\\result\\baidu\\som\\cmim\\new_baidu_SocialEffect_level%d.txt',i);

...
for i =1 :levelNum
finalLevelUserResultFileName = sprintf('..\\..\\..\\result\\flixster\\som\\snmim\\final_flixster_snmim_level_%d.txt',i);
fid = fopen(finalLevelUserResultFileName,'a');
fprintf(fid,'%f\t%f\t%f\r\n',avgUserEvaluationByLevel(i,2),avgUserEvaluationByLevel(i,3),avgUserEvaluationByLevel(i,4));
fclose(fid);
end

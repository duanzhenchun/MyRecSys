...
for m =1 :10
    topK = topKList(m);
    finalResultFileName=sprintf('..\\..\\..\\result\\baidu\\som\\snmim\\final_baidu_snmim_prf_top%d.txt',topK);
...
allUserRecInfoFile = sprintf('..\\..\\..\\result\\baidu\\som\\snmim\\allUserRecInfo%d.mat',version);

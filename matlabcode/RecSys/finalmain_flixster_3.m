...
for m =1 :10
    topK = topKList(m);
    finalResultFileName=sprintf('..\\..\\..\\result\\flixster\\som\\cmim\\final_flixster_cmim_prf_top%d.txt',topK);
...
allUserRecInfoFile = sprintf('..\\..\\..\\result\\flixster\\som\\cmim\\allUserRecInfo%d.mat',version);

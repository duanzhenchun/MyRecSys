...
for version = 1:30
    ...
    allUserRecInfoFile = sprintf('..\\..\\..\\result\\baidu\\som\\%s\\allUserRecInfo%d.mat',algorithm,version);   
    ...
    finalDiversityFileName=sprintf('..\\..\\..\\result\\baidu\\som\\%s\\final_baidu_%s_diversity_topK%d.txt',algorithm,algorithm,topK);
    finalColdUserResultFileName = sprintf('..\\..\\..\\result\\baidu\\som\\%s\\final_baidu_%s_colduser_topK%d.txt',algorithm,algorithm,topK);

...
alpha=0.8; % 兴趣合并的参数，rating=alpha，social=1-alpha
...
for m =1 :10
    topK = topKList(m);
    finalResultFileName=sprintf('..\\..\\..\\result\\baidu\\som\\pbmim\\final_baidu_pbmim_prf_top%d.txt',topK);
...
allUserRecInfoFile = sprintf('..\\..\\..\\result\\baidu\\som\\pbmim\\allUserRecInfo%d.mat',version);

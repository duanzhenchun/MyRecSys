...
resultFileName=sprintf('..\\..\\..\\result\\baidu\\mf_topN\\baidu_mf_result_%d_%s.txt',version,date);
...
modelFileName = sprintf('..\\..\\..\\data\\baidu\\mfdata_topN\\MF_fac20_rm1_wm0.700_lamb0.100_ver%d.mat',version); %SVD模型文件名

...
resultFileName=sprintf('..\\..\\..\\result\\baidu\\trustcfulf\\baidu_trustcfulf_result_%d_%s.txt',version,date);
...
saveRecListFileName=sprintf('..\\..\\..\\data\\baidu\\trustcfulfdata\\recList\\reclist%d.mat',version);
...
%     disp(i);
    ...
    % 找到这些neighbor看过的item，做成集合unionItemSet1
   ...
   %% ************** unionItemset 2 ********************** 
    ...
    % 找到这些neighbor看过的item，做成集合unionItemSet2
...
for m =1 :10
    topK = topKList(m);
    finalResultFileName=sprintf('..\\..\\..\\result\\baidu\\trustcfulf\\final_baidu_trustcfulf_prf_top%d.txt',topK);
...
allUserRecInfoFile = sprintf('..\\..\\..\\result\\baidu\\trustcfulf\\allUserRecInfo%d.mat',version);

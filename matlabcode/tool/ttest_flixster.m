...
cfulfName = sprintf('..\\..\\..\\result\\flixster\\cfulf\\final_flixster_cfulf_prf_top%d.txt',topK);
puretrustName = sprintf('..\\..\\..\\result\\flixster\\puretrust\\final_flixster_puretrust_prf_top%d.txt',topK);
trustcfulfName = sprintf('..\\..\\..\\result\\flixster\\trustcfulf\\final_flixster_trustcfulf_prf_top%d.txt',topK);
pbmimName=sprintf('..\\..\\..\\result\\flixster\\som\\pbmim\\final_flixster_pbmim_prf_top%d.txt',topK);
snmimName=sprintf('..\\..\\..\\result\\flixster\\som\\snmim\\final_flixster_snmim_prf_top%d.txt',topK);
cmimName=sprintf('..\\..\\..\\result\\flixster\\som\\cmim\\final_flixster_cmim_prf_top%d.txt',topK);

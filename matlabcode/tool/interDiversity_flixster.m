...
cfulfFile = sprintf('..\\..\\..\\result\\flixster\\cfulf\\allUserFinalRecList%d.mat',version);
puretrustFile = sprintf('..\\..\\..\\result\\flixster\\puretrust\\allUserFinalRecList%d.mat',version);
trustcfulfFile = sprintf('..\\..\\..\\result\\flixster\\trustcfulf\\allUserFinalRecList%d.mat',version);
pbmimFile =  sprintf('..\\..\\..\\result\\flixster\\som\\pbmim\\allUserFinalRecList%d.mat',version);
snmimFile =  sprintf('..\\..\\..\\result\\flixster\\som\\snmim\\allUserFinalRecList%d.mat',version);
cmimFile = sprintf('..\\..\\..\\result\\flixster\\som\\cmim\\allUserFinalRecList%d.mat',version);
...
finalDiversityFileName = sprintf('..\\..\\..\\result\\flixster\\flixster_diversity.txt');

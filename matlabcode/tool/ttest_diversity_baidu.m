...
cfulfName = sprintf('..\\..\\..\\result\\baidu\\cfulf\\final_baidu_cfulf_diversity_topK%d.txt',topK);
puretrustName = sprintf('..\\..\\..\\result\\baidu\\puretrust\\final_baidu_puretrust_diversity_topK%d.txt',topK);
trustcfulfName = sprintf('..\\..\\..\\result\\baidu\\trustcfulf\\final_baidu_trustcfulf_diversity_topK%d.txt',topK);
pbmimName=sprintf('..\\..\\..\\result\\baidu\\som\\pbmim\\final_baidu_pbmim_diversity_topK%d.txt',topK);
snmimName=sprintf('..\\..\\..\\result\\baidu\\som\\snmim\\final_baidu_snmim_diversity_topK%d.txt',topK);
cmimName=sprintf('..\\..\\..\\result\\baidu\\som\\cmim\\final_baidu_cmim_diversity_topK%d.txt',topK);

...
cfulfName = sprintf('..\\..\\..\\result\\baidu\\cfulf\\final_baidu_cfulf_colduser_diversity_topK%d.txt',topK);
puretrustName = sprintf('..\\..\\..\\result\\baidu\\puretrust\\final_baidu_puretrust_colduser_diversity_topK%d.txt',topK);
trustcfulfName = sprintf('..\\..\\..\\result\\baidu\\trustcfulf\\final_baidu_trustcfulf_colduser_diversity_topK%d.txt',topK);
pbmimName=sprintf('..\\..\\..\\result\\baidu\\som\\pbmim\\final_baidu_pbmim_colduser_diversity_topK%d.txt',topK);
snmimName=sprintf('..\\..\\..\\result\\baidu\\som\\snmim\\final_baidu_snmim_colduser_diversity_topK%d.txt',topK);
cmimName=sprintf('..\\..\\..\\result\\baidu\\som\\cmim\\final_baidu_cmim_colduser_diversity_topK%d.txt',topK);

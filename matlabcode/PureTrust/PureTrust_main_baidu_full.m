...
resultFileName=sprintf('..\\..\\..\\result\\baidu\\puretrust\\baidu_puretrust_result_%d_%s.txt',version,date);
...
saveRecListFileName=sprintf('..\\..\\..\\data\\baidu\\puretrustdata\\recList\\reclist%d.mat',version);
...
for m =1 :10
    topK = topKList(m);
    finalResultFileName=sprintf('..\\..\\..\\result\\baidu\\puretrust\\final_baidu_puretrust_prf_top%d.txt',topK);
...
allUserRecInfoFile = sprintf('..\\..\\..\\result\\baidu\\puretrust\\allUserRecInfo%d.mat',version);

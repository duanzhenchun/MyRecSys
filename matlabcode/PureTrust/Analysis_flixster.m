...
for version = 1:30
    ...
    finalDiversityFileName=sprintf('..\\..\\..\\result\\flixster\\%s\\final_flixster_%s_diversity_topK%d.txt',algorithm,algorithm,topK);
    finalColdUserResultFileName = sprintf('..\\..\\..\\result\\flixster\\%s\\final_flixster_%s_colduser_topK%d.txt',algorithm,algorithm,topK);

...
cfulfFileName = sprintf('..\\..\\..\\data\\baidu\\finaldata\\cfulfTopN.txt');
pureTrustFileName = sprintf('..\\..\\..\\data\\baidu\\finaldata\\pureTrustTopN.txt');
trustcfulfFileName = sprintf('..\\..\\..\\data\\baidu\\finaldata\\trustcfulfTopN.txt');
cmimFileName = sprintf('..\\..\\..\\data\\baidu\\finaldata\\cmimTopN.txt');
pbmimFileName = sprintf('..\\..\\..\\data\\baidu\\finaldata\\pbmimTopN.txt');
snmimFileName = sprintf('..\\..\\..\\data\\baidu\\finaldata\\snmimTopN.txt');

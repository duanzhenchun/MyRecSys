...
resultFileName=sprintf('..\\..\\..\\result\\flixster\\cfulf\\flixster_cfulf_result_%d_%s.txt',version,date);
...
saveRecListFileName=sprintf('..\\..\\..\\data\\flixster\\clulfdata\\recList\\reclist%d.mat',version);
...
for m =1 :10
    topK = topKList(m);
    finalResultFileName=sprintf('..\\..\\..\\result\\flixster\\cfulf\\final_flixster_cfulf_prf_top%d.txt',topK);
...
allUserRecInfoFile = sprintf('..\\..\\..\\result\\flixster\\cfulf\\allUserRecInfo%d.mat',version);
